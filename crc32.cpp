...
unsigned long cCRC32::m_CRCTable[256] = 
{
...
unsigned long cCRC32::crc(unsigned char *key, int len, unsigned long lasthash)
{
    register unsigned long hash;
    
    /* compute hash with the help of the table */
    hash = lasthash ^ 0xffffffff;
    while (len-- > 0)
        hash = m_CRCTable[(hash ^ *key++) & 0xff] ^ (hash >> 8);
    hash ^= 0xffffffff;
